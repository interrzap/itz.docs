...
<Steps>
  ...
  <Step title="Invite your team members">
    Start sending email invitations to your team members and give them access to your InterrZap Workspace. With advanced tiers, you can give them Roles and set up RBAC., and also, with a user-friendly interface, you can select which services are accessible to specific team members.
  ...
  <Step title="Browse the Marketplace">
    Browse the marketplace and add the services tailored to your team's niche and necessity, directly into your Environment.
